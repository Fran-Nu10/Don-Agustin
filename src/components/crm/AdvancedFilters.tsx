  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        {/* Budget range filter */}
        <div className="relative">
          <DollarSign className="absolute left-3 top-3 h-4 w-4 text-secondary-400 pointer-events-none" />
          <select
        ...
        <div className="relative">
          <Calendar className="absolute left-3 top-3 h-4 w-4 text-secondary-400 pointer-events-none" />
          <select
            value={filters.hasScheduledDate}
            onChange={(e) => onFilterChange('hasScheduledDate', e.target.value)}
            className="block w-full pl-10 pr-8 py-2 bg-white border border-secondary-300 rounded-md text-secondary-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 appearance-none"
          >
            <option value="all">Todas las citas</option>
            <option value="scheduled">Con cita agendada</option>
            <option value="unscheduled">Sin cita agendada</option>
          </select>
        </div>

        {/* Last contact filter */}
        <div className="relative">
          <Clock className="absolute left-3 top-3 h-4 w-4 text-secondary-400 pointer-events-none" />
          <select
            value={filters.lastContactDays}
            onChange={(e) => onFilterChange('lastContactDays', e.target.value)}
            className="block w-full pl-10 pr-8 py-2 bg-white border border-secondary-300 rounded-md text-secondary-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 appearance-none"
          >

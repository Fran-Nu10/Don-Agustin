/*
  # Agregar funcionalidades completas a los viajes

  1. Cambios en la tabla trips
    - Agregar columna created_by para rastrear quién creó el viaje
    - Actualizar categorías disponibles

  2. Nuevas tablas
    - itinerary_days: Para el itinerario diario de cada viaje
    - included_services: Para los servicios incluidos en cada viaje
...
-- Políticas RLS para itinerary_days
...
-- Políticas RLS para included_services
